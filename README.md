## J. Nicolas — building the action layer for AI agents
...
- 🤖 **[OneShot](https://github.com/oneshot-agent/sdk)** — the commercial action layer for AI agents. 26+ tools, x402 pay-per-call in USDC on Base, signed receipts, MCP. `240★`
